...
- **CEO Judge** (Business/Impact perspective)
- **CTO Judge** (Technical/Architecture perspective)
...
- **Cross-Reference:** Verify CEO and CTO JSON outputs are internally consistent.
...
- The CEO and CTO both evaluate all 9 categories.
- The Head Judge (via script calculation) applies specific weights to each category depending on whether it is Business-focused (CEO dominant: 70/30) or Technical-focused (CTO dominant: 30/70).
...
1. **Integrity Report**
2. **CEO-CTO Score Cross-Reference Table**
